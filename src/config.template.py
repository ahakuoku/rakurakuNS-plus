...
# 使用する前に、コマンド「pip install psutil schedule discord」を実行する必要があります。
...
# long_backup_keep  : 長期バックアップを保管する日数を設定します。0を指定すると長期バックアップを行いません。-1を指定すると無期限保管します。
# long_backup_time  : 長期バックアップを行う時刻を設定します。5時に行うのであれば「5」と指定します。
